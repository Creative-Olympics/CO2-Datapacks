...
scoreboard players set #lib.start_animation.animate data 1
...
execute if score @s start_animation.frame matches 100 run function lib:start_animation/callback with entity @s data.start_animation

...
# tellraw @a [{"selector":"@s"},{"text":" > global:relocalize/animation","color":"gray"}]
...
# Horizontal phase
execute if score @s reloc.timer matches 30 run function global:relocalize/get_direction
...
# Descending phase
execute if score @s reloc.timer matches 60 run function global:relocalize/get_height
...
execute if score @s reloc.timer matches 81.. at @s run function global:relocalize/stop

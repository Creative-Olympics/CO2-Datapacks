...
execute as @a[tag=prophunt.current.player,tag=!prophunt.is_locked] at @s run function prophunt:features/lock_position/lock
execute as @a[tag=prophunt.current.player,tag=prophunt.unlock] at @s run function prophunt:features/lock_position/unlock

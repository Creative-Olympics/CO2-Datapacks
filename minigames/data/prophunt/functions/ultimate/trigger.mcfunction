# Executed globally
# tellraw @a {"text":"prophunt:ultimate/trigger"}
...
# Can use it
execute as @a[tag=prophunt.ultimate_trigger,scores={prophunt.ultimate_timer=0}] if score @s prophunt.ultimate_points >= $prophunt.ultimate_cost data at @s run function prophunt:ultimate/start
execute as @a[scores={prophunt.ultimate_timer=1..}] at @s run function prophunt:ultimate/animation

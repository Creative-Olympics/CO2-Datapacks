...
execute as @a[scores={prophunt.jump_trigger=1..,prophunt.climb=0}] at @s rotated ~ 0 positioned ^ ^ ^0.7 if predicate prophunt:can_climb run function prophunt:climb/start

# Climb animation
execute as @a[scores={prophunt.climb=1..}] at @s run function prophunt:climb/animation

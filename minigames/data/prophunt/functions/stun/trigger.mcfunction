...
# Can use it
execute as @a[tag=prophunt.stun_trigger,scores={prophunt.stun_hunters_cooldown=0}] at @s run function prophunt:stun/stun_hunters
...
execute as @a[tag=prophunt.is_hunter,scores={prophunt.stuned=1..}] at @s run function prophunt:stun/stuned

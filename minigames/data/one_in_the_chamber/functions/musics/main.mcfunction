...
execute if score #oitc.musics.timer data matches 1 as @a[team=oitc] at @s run playsound one_in_the_chamber:theme-1 music @s ~ ~ ~ 0.5 1 0

# After 1m 40s
execute if score #oitc.musics.timer data matches 2040 run stopsound @a[team=oitc] music
execute if score #oitc.musics.timer data matches 2040 as @a[team=oitc] at @s run playsound one_in_the_chamber:theme-2 music @s ~ ~ ~ 0.5 1 0

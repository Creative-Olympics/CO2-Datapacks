...
# Start
execute if score #oitc.musics.timer data matches 1 run stopsound @a[team=oitc] record
...
# After 1m 40s
execute if score #oitc.musics.timer data matches 2040 run stopsound @a[team=oitc] record

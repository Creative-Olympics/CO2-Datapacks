...
execute store result score #result data if entity @a[team=dropper,tag=!dropper.jump_complete]
execute if score #result data matches 0 run function dropper:jump/reset/process

...
# First theme (1m 28s)
execute if score #dropper.music_timer data matches 0 as @a[team=dropper] at @s run stopsound @s record
...
# Second theme (1m 6s)
execute if score #dropper.music_timer data matches 1780 as @a[team=dropper] at @s run stopsound @s record
...
# Third theme (1m 6s)
execute if score #dropper.music_timer data matches 3120 as @a[team=dropper] at @s run stopsound @s record

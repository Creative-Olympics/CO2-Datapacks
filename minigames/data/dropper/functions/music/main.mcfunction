...
execute if score #dropper.music_timer data matches 0 as @a[team=dropper] at @s run playsound dropper:theme-1 music @s ~ ~ ~ 0.5 1 0

# Second theme (1m 6s)
execute if score #dropper.music_timer data matches 1780 as @a[team=dropper] at @s run stopsound @s music
execute if score #dropper.music_timer data matches 1780 as @a[team=dropper] at @s run playsound dropper:theme-2 music @s ~ ~ ~ 0.5 1 0

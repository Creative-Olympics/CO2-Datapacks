...
execute unless score @s wallstreet.selected_quantity matches 0 if entity @s[tag=!wallstreet.villager.sell] run function wallstreet:villager/transaction/buy
execute unless score @s wallstreet.selected_quantity matches 0 if entity @s[tag=wallstreet.villager.sell] run function wallstreet:villager/transaction/sell
execute unless score @s wallstreet.selected_quantity matches 0 run function wallstreet:villager/refresh_price/selected

...
execute if score #profit tmp matches 1.. as @e[tag=wallstreet.villager.talking,limit=1,sort=nearest] at @s anchored eyes positioned ^ ^0.5 ^1.3 run summon text_display ~ ~ ~ {text:'[{"text":"YOU MADE ","color":"green","bold":true,"italic":true},{"score":{"name":"#profit","objective":"tmp"},"color":"yellow","bold":true,"italic":true},{"text":"","color":"white","bold":false,"italic":false},{"text":" PROFIT!","color":"green","bold":true,"italic":true}]',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["wallstreet.entity","wallstreet.villager.gui.new","wallstreet.villager.gui.benefits"],background:1677721600,teleport_duration:1}
...
execute if score #profit tmp matches ..-1 as @e[tag=wallstreet.villager.talking,limit=1,sort=nearest] at @s anchored eyes positioned ^ ^0.5 ^1.3 run summon text_display ~ ~ ~ {text:'[{"text":"YOU LOST ","color":"red","bold":true,"italic":true},{"score":{"name":"#profit_abs","objective":"tmp"},"color":"tellow","bold":true,"italic":true},{"text":"","color":"white","bold":false,"italic":false}]',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["wallstreet.entity","wallstreet.villager.gui.new","wallstreet.villager.gui.benefits"],background:1677721600,teleport_duration:1}

...
# Get price
execute if entity @s[scores={wallstreet.selected_resource=0}] run scoreboard players operation #price tmp = @s wallstreet.wood_price
execute if entity @s[scores={wallstreet.selected_resource=1}] run scoreboard players operation #price tmp = @s wallstreet.stone_price
execute if entity @s[scores={wallstreet.selected_resource=2}] run scoreboard players operation #price tmp = @s wallstreet.leather_price
execute if entity @s[scores={wallstreet.selected_resource=3}] run scoreboard players operation #price tmp = @s wallstreet.iron_price
execute if entity @s[scores={wallstreet.selected_resource=4}] run scoreboard players operation #price tmp = @s wallstreet.diamond_price
scoreboard players operation #price tmp *= 1000 const

# Get quantity
scoreboard players operation #quantity tmp = @s wallstreet.selected_quantity

# Update villager quantity
execute if entity @s[scores={wallstreet.selected_resource=0}] run scoreboard players operation @s wallstreet.wood_quantity += #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=1}] run scoreboard players operation @s wallstreet.stone_quantity += #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=2}] run scoreboard players operation @s wallstreet.leather_quantity += #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=3}] run scoreboard players operation @s wallstreet.iron_quantity += #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=4}] run scoreboard players operation @s wallstreet.diamond_quantity += #quantity tmp

# Get average bought price
execute if entity @s[scores={wallstreet.selected_resource=0}] run scoreboard players operation #average_value tmp = @p[tag=wallstreet.villager.client] wallstreet.wood_price
execute if entity @s[scores={wallstreet.selected_resource=1}] run scoreboard players operation #average_value tmp = @p[tag=wallstreet.villager.client] wallstreet.stone_price
execute if entity @s[scores={wallstreet.selected_resource=2}] run scoreboard players operation #average_value tmp = @p[tag=wallstreet.villager.client] wallstreet.leather_price
execute if entity @s[scores={wallstreet.selected_resource=3}] run scoreboard players operation #average_value tmp = @p[tag=wallstreet.villager.client] wallstreet.iron_price
execute if entity @s[scores={wallstreet.selected_resource=4}] run scoreboard players operation #average_value tmp = @p[tag=wallstreet.villager.client] wallstreet.diamond_price

# Update player quantity
execute if entity @s[scores={wallstreet.selected_resource=0}] run scoreboard players operation @p[tag=wallstreet.villager.client] wallstreet.wood_quantity -= #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=1}] run scoreboard players operation @p[tag=wallstreet.villager.client] wallstreet.stone_quantity -= #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=2}] run scoreboard players operation @p[tag=wallstreet.villager.client] wallstreet.leather_quantity -= #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=3}] run scoreboard players operation @p[tag=wallstreet.villager.client] wallstreet.iron_quantity -= #quantity tmp
execute if entity @s[scores={wallstreet.selected_resource=4}] run scoreboard players operation @p[tag=wallstreet.villager.client] wallstreet.diamond_quantity -= #quantity tmp

# Update player budget
scoreboard players operation #billing_3 tmp = #quantity tmp
scoreboard players operation #billing_3 tmp *= #price tmp
scoreboard players operation #billing tmp = #billing_3 tmp
...
scoreboard players operation #profit tmp /= 1000 const
scoreboard players operation #profit tmp += #billing tmp

# Relative diff
scoreboard players operation #diff tmp = #billing_3 tmp
scoreboard players operation #diff tmp /= #quantity tmp
scoreboard players operation #diff tmp *= 100 const
scoreboard players operation #diff tmp /= #average_value tmp
scoreboard players operation #diff tmp -= 100 const
...
execute if score #profit tmp matches 1.. run tellraw @a[team=wallstreet] [ \
    ...
    {"score":{"name":"#diff","objective":"tmp"},"color":"green","bold":false,"italic":false}, \
    {"text":"%)","color":"green","bold":false,"italic":false} \
]
...
execute if score #profit tmp matches ..-1 run tellraw @a[team=wallstreet] [ \
    ...
    {"score":{"name":"#diff","objective":"tmp"},"color":"red","bold":false,"italic":false}, \
    {"text":"%)","color":"red","bold":false,"italic":false} \
]

...
execute unless score @s wallstreet.selected_quantity matches 0 as @e[tag=wallstreet.villager.talking,limit=1,sort=nearest] at @s anchored eyes positioned ^ ^ ^1.3 run summon text_display ~ ~ ~ {text:'[{"text":"✔","color":"green","bold":false,"italic":false},{"text":" Deal !","color":"white","bold":false,"italic":false}]',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["wallstreet.villager.gui","wallstreet.villager.gui.new","wallstreet.villager.gui.deal"],background:1677721600}

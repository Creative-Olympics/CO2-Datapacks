...
# Stock & Price labels
execute as @e[tag=wallstreet.villager.talking,limit=1,sort=nearest] at @s anchored eyes positioned ^0.15 ^0.85 ^1 run summon text_display ~ ~ ~ {text:'[{"text":"Price: ","color":"white","bold":false,"italic":false},{"text":"\\nStock: ","color":"white","bold":false,"italic":false}]',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,1f]},Tags:["wallstreet.villager.gui","wallstreet.villager.gui.new"],alignment:"left",background:0}
# Stock & Price values
execute as @e[tag=wallstreet.villager.talking,limit=1,sort=nearest] at @s anchored eyes positioned ^0.75 ^0.85 ^1 run summon text_display ~ ~ ~ {text:'{"text":"placeholder"}',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,1f]},Tags:["wallstreet.villager.gui","wallstreet.villager.gui.new","wallstreet.villager.gui.display.villager_info"],alignment:"right",background:0}
# Max stock
execute as @e[tag=wallstreet.villager.talking,limit=1,sort=nearest] at @s anchored eyes positioned ^0.45 ^0.75 ^1 run summon text_display ~ ~ ~ {text:'{"text":"placeholder"}',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.3f,0.3f,1f]},Tags:["wallstreet.villager.gui","wallstreet.villager.gui.new","wallstreet.villager.gui.display.villager_info.max_stock"],background:0}
# Buy / Sell display

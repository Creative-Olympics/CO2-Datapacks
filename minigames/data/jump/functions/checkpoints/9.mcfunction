...
execute unless entity @e[tag=jump.checkpoint.9] run summon marker -270.5 108.5 25.5 {Tags:["jump.checkpoint","jump.checkpoint.9"]}
execute as @e[tag=jump.checkpoint.9] at @s run particle dust 0.565 0.000 1.000 1 ~ ~ ~ 0 5 0 0 10 normal @a[scores={jump.step=8}]
execute as @e[tag=jump.checkpoint.9] at @s run particle minecraft:totem_of_undying ^ ^ ^2 0.1 0.1 0.1 0 3 normal @a[scores={jump.step=8}]
execute as @e[tag=jump.checkpoint.9] at @s run particle minecraft:totem_of_undying ^ ^ ^-2 0.1 0.1 0.1 0 3 normal @a[scores={jump.step=8}]

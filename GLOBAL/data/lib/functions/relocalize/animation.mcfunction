...
# tellraw @a [{"selector":"@s"},{"text":" > lib:relocalize/animation","color":"gray"}]
...
# Horizontal phase
execute if score @s reloc.timer matches 30 run function lib:relocalize/get_direction
...
# Descending phase
execute if score @s reloc.timer matches 60 run function lib:relocalize/get_height
...
execute if score @s reloc.timer matches 81.. at @s run function lib:relocalize/stop

execute if score TNT_RUN gameStarted matches 1 run function tnt_run:game_started

execute if score TNT_RUN gameStarted matches 1 unless entity @a[tag=tnt_run.inGame] run function tnt_run:end_game

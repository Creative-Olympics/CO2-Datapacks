...
# tellraw @a {"text":"prophunt:events/cycle_prop_variation"}
...
# Refresh prop
execute unless score #old_variation data = @s prophunt.prop_variation run function prophunt:events/refresh_prop_display

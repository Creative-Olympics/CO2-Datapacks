...
function prophunt:events/refresh_prop_display

# Hitbox
execute if score @s prophunt.prop_type matches 6 run summon interaction ~ ~ ~ {Tags:["prophunt","prophunt.entity","prophunt.entity.new","prophunt.interaction","prophunt.interaction.bottom","prophunt.interaction.top"],width:3f,height:3.5f}
execute if score @s prophunt.prop_type matches 7 run summon interaction ~ ~ ~ {Tags:["prophunt","prophunt.entity","prophunt.entity.new","prophunt.interaction","prophunt.interaction.bottom","prophunt.interaction.top"],width:5f,height:7f}
execute unless score @s prophunt.prop_type matches 6..7 run summon interaction ~ ~ ~ {Tags:["prophunt","prophunt.entity","prophunt.entity.new","prophunt.interaction","prophunt.interaction.bottom","prophunt.interaction.top"],width:2.5f,height:2.5f}

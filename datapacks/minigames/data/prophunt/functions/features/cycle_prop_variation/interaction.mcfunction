...
# tellraw @a [{"text":"prophunt:features/cycle_prop_variation/interaction   as   "},{"selector":"@s"}]
...
execute as @a[tag=prophunt.current.actor,tag=prophunt.current.player] at @s run function prophunt:features/cycle_prop_variation/run

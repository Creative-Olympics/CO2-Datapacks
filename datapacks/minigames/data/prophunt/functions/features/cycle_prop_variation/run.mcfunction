...
# tellraw @a [{"text":"prophunt:features/cycle_prop_variation/run   as   "},{"selector":"@s"}]
...
# Refresh prop
execute unless score #old_variation data = @s prophunt.prop_variation run function prophunt:features/prop_display/refresh

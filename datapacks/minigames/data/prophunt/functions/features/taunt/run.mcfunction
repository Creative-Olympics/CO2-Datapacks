...
execute at @a[tag=prophunt.is_hunter,distance=..30] as @s anchored eyes positioned ^ ^ ^1 as @e[tag=prophunt.entity.new,tag=prophunt.position_indicator] run function prophunt:features/taunt/indicate_direction

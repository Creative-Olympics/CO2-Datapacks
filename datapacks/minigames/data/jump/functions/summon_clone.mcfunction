...
loot replace entity @e[type=husk,tag=jump.animation.new] armor.head loot lib:givehead
data modify entity @e[type=husk,tag=jump.animation.new,limit=1] ArmorItems[3].tag.SkullOwner.Name set from block -1 50 -1 Text1.insertion

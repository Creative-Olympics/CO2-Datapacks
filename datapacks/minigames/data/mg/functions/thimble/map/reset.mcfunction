fill 125 81 18 133 102 26 structure_void replace barrier
fill 135 87 29 141 92 35 structure_void replace barrier
setblock 139 87 33 air destroy
fill 126 80 19 132 80 25 water destroy

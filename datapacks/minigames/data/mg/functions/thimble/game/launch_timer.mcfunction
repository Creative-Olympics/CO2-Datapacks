...
execute if score THIMBLE_START_TIMER data matches 1..3 run schedule function mg:thimble/game/launch_timer 1s

execute if score THIMBLE_START_TIMER data matches 1 run function mg:thimble/player/reset_all

function mg:thimble/map/setup
...
execute if score THIMBLE_START_TIMER data matches 4 as @a[tag=thimble.inGame] run function mg:thimble/get_order

...
function mg:thimble/player_state

# Jump Complete
execute as @a[tag=thimble.inGame,tag=thimble.yourTurn] at @s if block ~ ~ ~ water run tag @s add thimble.jumpComplete
execute as @a[tag=thimble.jumpComplete] run function mg:thimble/set_wool
execute as @a[tag=thimble.jumpComplete] run function mg:thimble/detect_dac
...
execute if entity @a[tag=thimble.inGame,scores={thimble.lives=1..}] unless entity @a[tag=thimble.yourTurn] run function mg:thimble/get_next_player

execute unless entity @a[tag=thimble.inGame,scores={thimble.lives=1..}] run function mg:thimble/game/stop
...
execute if score FILLED thimble matches 25 run function mg:thimble/game/stop
